...
export default function ConnectedAccountsIndex({ platforms, subscription }: Props) {
    ...
    const handleSaveSettings = () => {
        ...
        setSaving(true);
        router.put(
            route('connected-accounts.update', connection.id),
            settings,
            {
                onSuccess: () => {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <PageContainer maxWidth="4xl">
                ...
                <HeadingSmall
                    ...
                    description="Connect your social media accounts to enable comment moderation."
                />
                        ...
                        <div className="space-y-6 py-4">
                            ...
                            <div className="flex items-center justify-between">
                                <div className="space-y-0.5">
                                    ...
                                    <p className="text-muted-foreground text-sm">
                                        Automatically scan and delete matching comments
                                    </p>
                                </div>
                                <Switch
                            ...
                            {settings.auto_moderation_enabled && selectedMethod === 'api' && (
                                <div className="space-y-2">
                                    ...
                                    <CustomSelect
                                        ...
                                        value={scanFrequencyOptions.find(
                                            (o) => o.value === settings.scan_frequency_minutes
                                        )}
                                        onChange={(selected) =>
                                            setSettings((prev) => ({
                                                ...prev,
        ...
        <Card className={hasAnyConnection ? 'border-green-200 dark:border-green-800' : ''}>
            <CardHeader className="pb-3">
                <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                        <span className={`rounded-lg p-2.5 ${platformColors[platform.name]}`}>
...
function ConnectionMethodRow({
    ...
    return (
        <div className="rounded-lg border p-4">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <span className={`rounded p-1.5 ${isApi ? 'bg-blue-100 text-blue-600 dark:bg-blue-900/30' : 'bg-purple-100 text-purple-600 dark:bg-purple-900/30'}`}>
                        {isApi ? <Link2 className="h-4 w-4" /> : <Puzzle className="h-4 w-4" />}
                    </span>
                    <div>
                        <div className="flex items-center gap-2">
                            <span className="font-medium text-sm">
                                {isApi ? 'API (OAuth)' : 'Browser Extension'}
                            </span>
                        ...
                        <>
                            <div className="text-right mr-2">
                                ...
                                {connection.is_token_expired && (
                                    <p className="text-xs text-amber-600">Token expired</p>
                                )}
            ...
            {isConnected && connection.last_scanned_at && (
                <div className="mt-3 pt-3 border-t flex items-center gap-2 text-muted-foreground text-xs">
